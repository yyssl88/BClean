...
class EvalEngine:
    ...
    def eval_report(self):
        ...
        try:
            ...
            report = "Precision = %.3f, Recall = %.3f, Repairing Recall = %.3f, F1 = %.3f, Repairing F1 = %.3f, Detected Errors = %d, Total Errors = %d, Correct Repairs = %d, Total Repairs = %d, Total Repairs on correct cells (Grdth present) = %d, Total Repairs on incorrect cells (Grdth present) = %d" % (
