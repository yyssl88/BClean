...
if __name__ == '__main__':
	...
	# attr.build(attr = "prvdr_id", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "frst_nm", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "lst_nm", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "adrs_id", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "adr_ln_1", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "cty", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "st", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "zip", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "org_pac_id", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
	# attr.build(attr = "NPI", type = "Categorical", min_v = 0, max_v = 300, null_allow = "N", repairable = "Y",
	#            pattern = None)
